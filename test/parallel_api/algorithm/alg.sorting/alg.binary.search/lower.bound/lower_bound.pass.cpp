...
void test_on_device()
{
    ...
    // call algorithm
    oneapi::dpl::lower_bound(TestUtils::default_dpcpp_policy, key_beg, key_end, val_beg , val_end, res_beg);
    ...
    auto new_policy = TestUtils::make_new_policy<class LowerBound>(TestUtils::default_dpcpp_policy);
